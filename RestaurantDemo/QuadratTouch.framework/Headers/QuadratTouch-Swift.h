...
*/
SWIFT_CLASS("_TtC12QuadratTouch33AuthorizationNavigationController")
@interface AuthorizationNavigationController : UINavigationController
...
SWIFT_CLASS("_TtC12QuadratTouch27AuthorizationViewController")
...
@interface NSError (SWIFT_EXTENSION(QuadratTouch))
@end
...
*/
SWIFT_PROTOCOL("_TtP12QuadratTouch28SessionAuthorizationDelegate_")
@protocol SessionAuthorizationDelegate
@optional
/**
  It can be useful if one needs 1password integration.
*/
- (void)sessionWillPresentAuthorizationViewControllerWithController:(AuthorizationViewController * _Nonnull)controller;
- (void)sessionWillDismissAuthorizationViewControllerWithController:(AuthorizationViewController * _Nonnull)controller;
@end
